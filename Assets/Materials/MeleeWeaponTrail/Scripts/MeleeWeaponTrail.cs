...
public class MeleeWeaponTrail : MonoBehaviour {
    ...
    void PlayerVelocity() {
        ...
        if (speed > highDamageVelocity) {
            speed = Mathf.Lerp(speed, playerRigidbody.velocity.magnitude, Time.deltaTime * 1f);
        } else {
            speed = Mathf.Lerp(speed, playerRigidbody.velocity.magnitude, Time.deltaTime * 4f);
        }
