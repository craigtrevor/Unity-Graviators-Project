...
public class PostEffect : MonoBehaviour 
{
	...
	void Start () 
	{
		...
		TempCam.transform.parent = this.gameObject.transform.parent;
		TempCam.cullingMask = layerMask;
	...
	void OnRenderImage(RenderTexture source, RenderTexture destination)
	{
		...
		//TempCam.cullingMask = 1 << LayerMask.NameToLayer("LocalPlayer");
		TempCam.cullingMask = layerMask;
		...
		//Post_Mat.SetTexture ("_MainTex", source);
